...
MOD.Igla = {
	...
	["B412A569-1413-11E0-A672-E0A480096E27"] = {
		...
		["CDC3C3F1-C14A-43D4-B97B-68C286DEFEA8"] = {
			...
			rayLength = 1500.0, -- 400.0
			lockOnVisibleTargetsOnly = true, -- true
			acceptanceAngle = 10.0, -- 5.0
...
MOD.Claymore = {
	...
	["8709A814-1FF9-11E0-8A74-C88A4F19AAB4"] = {
		...
		["AA3BA4F5-2F8E-65FD-016A-D1E6F8C870FB"] = {
			timeToLiveOnPlayerDeath = 0, -- Default = 1.0
			timeToLive = 900, -- Default = 0.0
			detonateOnTimeout = true, -- Default = False
			health = 5.0, -- 50.0
			maxCount = 32 -- 2
		}
	}
