require("__shared/Config2") -- Able to turn console spam stuff on or off, levelprint spam and sets the mod updatecheck stuff
require("__shared/reconmod/Config3") -- Able to turn console spam stuff on or off ,and the mod it self

require("__shared/pimped-gunmaster/config4") -- config file for the extended gunmaster kill config
require("__shared/pimped-gunmaster/GMMap_loader1")
require("__shared/pimped-gunmaster/GMMap_loader2")
